    ...
    <main className='flex flex-row w-full justify-center items-center my-12 text-white'>
        ...
        >
            <div className='flex flex-col gap-4 md:gap-2 my-2'>
                <p className=' font-Raleway text-3xl font-semibold'>Wanna Contact me?</p>
                <p className=' font-Onest text-lg font-extralight'>Feel free to contact me for anything!</p>
            </div>
            <div className='flex flex-row gap-12 md:mx-6 mx-2'>
              ...
              >
                ...
                <ModalContent backdropBlur='md' bgColor='blackAlpha.800' >
                  ...
                  <ModalCloseButton />
                      <form action="https://formsubmit.co/royishan2004@gmail.com" method="POST">
                  <ModalBody >
                    <Stack spacing={5} >
